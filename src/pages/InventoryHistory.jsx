...
import { Layout, Menu, Button, theme, Table, DatePicker, Input, Space, Tag, Select, Card, Row, Col } from 'antd';
                        ...
                        <Card style={{ marginBottom: 20, background: '#f5f5f5' }} bordered={false} size="small">
                            <Space wrap>
                                ...
                                <Select defaultValue="all" style={{ width: 150 }} onChange={setReasonFilter}>
                                    ...
                                    <Option value="입고 승인">입고 승인</Option>
                                    <Option value="입고 승인(신규)">입고 승인(신규)</Option>
